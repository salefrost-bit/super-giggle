...
| v0.4.8 | Ispravke iz žive probe 3 | doterivanje sesije: karta je kontrola, narandžasta Pauza + crveni ✕, toast animacija; refresh-persistencija ODLOŽENA za PWA spec — spec `specs/2026-07-17-ispravke-zive-probe-3-design.md` — ✅ Završen 2026-07-17 |
